 ...
 */
@Entity
public class VendasProdutoSecundario implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VendasProdutoSecundario)) {
            return false;
        }
        VendasProdutoSecundario other = (VendasProdutoSecundario) object;
        if (this.id != other.id) {
            return false;
        }
        return true;
    ...
    public String toString() {
        return "entidades.VendasProdutoSecundario[ id=" + id + " ]";
    }
